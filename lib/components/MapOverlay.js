...
const propTypes = {
  ...
  center: PropTypes.shape({
      /**
       * Coordinates for the center of the overlay image.
       */
  ...
  dimension: PropTypes.shape({
      /**
       * Dimension for overlay image on map.
       */
      width: PropTypes.number.isRequired,
      height: PropTypes.number.isRequired,
  }).isRequired,
  zIndex: PropTypes.number,
  bearingAngle: PropTypes.number.isRequired // tilt angle for overlay image
};
